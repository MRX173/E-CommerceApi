        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserAddress_AddressLine = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserAddress_City = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserAddress_Country = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustumUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_AspNetUsers_CustumUserId",
                        column: x => x.CustumUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustumUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Created = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    LastModified = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserPayments_AspNetUsers_CustumUserId",
                        column: x => x.CustumUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_CustumUserId",
                table: "OrderDetails",
                column: "CustumUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductComments_CustumUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductRates_CustumUserId",
                table: "ProductRates",
                column: "CustumUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingSessions_CustumUserId",
                table: "ShoppingSessions",
                column: "CustumUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserPayments_CustumUserId",
                table: "UserPayments",
                column: "CustumUserId");
        }
